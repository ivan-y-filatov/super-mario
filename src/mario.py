...
cactus_img = pygame.image.load('../resources/images/cactus_bricks.png')
cactus_img_rect = cactus_img.get_rect()
cactus_img_rect.left = 0
fire_img = pygame.image.load('../resources/images/fire_bricks.png')
...
class Dragon:
    ...
    def __init__(self):
        self.dragon_img = pygame.image.load('../resources/images/dragon.png')
...
class Flames:
    ...
    def __init__(self):
        self.flames = pygame.image.load('../resources/images/fireball.png')
...
def game_over():
    ...
    music = pygame.mixer.Sound('../resources/sound/mario_dies.wav')
    music.play()
...
def start_game():
    canvas.fill(BLACK)
    start_img = pygame.image.load('../resources/images/start.png')
...
def game_loop():
    while True:
        ...
        global  HIGH_SCORE
        flames_list = []
        pygame.mixer.music.load('../resources/sound/mario_theme.wav')
